...
import org.fossify.arfoxphone.databinding.ActivityCallBinding
import org.fossify.arfoxphone.dialogs.DynamicBottomSheetChooserDialog
import org.fossify.arfoxphone.extensions.*
import org.fossify.arfoxphone.helpers.*
import org.fossify.arfoxphone.models.AudioRoute
import org.fossify.arfoxphone.models.CallContact
...
class CallActivity : SimpleActivity() {
    ...
    private fun addLockScreenFlags() {
        ...
        try {
            ...
            screenOnWakeLock = powerManager.newWakeLock(PowerManager.FULL_WAKE_LOCK, "org.fossify.arfoxphone:full_wake_lock")
    ...
    private fun enableProximitySensor() {
        if (!config.disableProximitySensor && (proximityWakeLock == null || proximityWakeLock?.isHeld == false)) {
            val powerManager = getSystemService(Context.POWER_SERVICE) as PowerManager
            proximityWakeLock = powerManager.newWakeLock(PowerManager.PROXIMITY_SCREEN_OFF_WAKE_LOCK, "org.fossify.arfoxphone:wake_lock")
